    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group {{ $errors->has('title') ? 'has-error has-feedback' : '' }}">
                ...
                <input type="text" class="form-control" name="title" id="title" value="{{ Input::old('title', $page->title) }}" placeholder="@lang('admin/pages.form.placeholders.title')">
                @if( $errors->has('title' ) )
            ...
            <div class="row">
                <div class="col-xs-6">
                    <div class="form-group {{ $errors->has('published_on_date') ? 'has-error has-feedback' : '' }}">
                        ...
                        <input class="form-control" type="date" name="published_on_date" id="published_on_date" value="{{ date('Y-m-d', max(strtotime(Input::old('published_on_date', $page->published_on)), 0)) }}" placeholder="aaaa-mm-dd">
                ...
                <div class="col-xs-6">
                    <div class="form-group {{ $errors->has('published_on_time') ? 'has-error has-feedback' : '' }}">
                        ...
                        <input type="time" class="form-control" name="published_on_time" id="published_on_time" value="{{ date('H:i', max(strtotime(Input::old('published_on_date', $page->published_on)), 0)) }}" placeholder="07:00">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="form-group">
                        ...
                        <label for="use_current_time" {{ Input::old('use_current_time') ? 'checked="checked"' : '' }}>@lang('admin/pages.form.labels.use_current_time')</label>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                ...
                <textarea class="form-control summernote" name="excerpt" id="excerpt" rows="5">{{ Input::old('excerpt', $page->excerpt) }}</textarea>
            </div>
        </div>
        <div class="col-md-12">
            <div class="form-group">
                <label for="content">@lang('admin/pages.form.labels.content')</label>
                <textarea class="form-control summernote" name="content" id="content" rows="15">{{ Input::old('content', $page->content) }}</textarea>
            </div>
        </div>
    </div>
    {{ Form::token() }}
