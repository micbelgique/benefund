    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group {{ $errors->has('description') ? 'has-error has-feedback' : '' }}">
                ...
                <textarea class="form-control" rows="3" name="description" id="description" value="{{ Input::old('description') }}">
                </textarea>
        ...
        <div class="col-md-6">
            <div class="form-group {{ $errors->has('item_target_description') ? 'has-error has-feedback' : '' }}">
                ...
                <textarea class="form-control" rows="3" name="target_description" id="target_description" value="{{ Input::old('target_description') }}">
                </textarea>
