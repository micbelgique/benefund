            ...
            <div class="col-xs-12">
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        ...
                        <p style="height: 100px">{{ strlen($campaign->description) > 203 ? substr($campaign->description, 0, 200) . '...' : $campaign->description }}</p>
                        <div class="row">
        ...
        @else
            ...
            <div class="col-xs-4 col-md-4 col-sm-4">
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        <h3>{{ $campaign->title }}</h3>
                        <p>{{ strlen($campaign->description) > 203 ? substr($campaign->description, 0, 200) . '...' : $campaign->description }}</p>
                        <hr>
