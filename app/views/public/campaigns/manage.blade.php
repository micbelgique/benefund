...
<div class="row">
    <div class="col-xs-12">
        ...
        <div class="pull-right">
            <p>
                <form action="{{ URL::route('public.campaigns.manage') }}" type="get" class="form-inline">
            ...
            <td colspan="2">
                <form action="{{ URL::route('public.campaigns.delete', [$campaign->id]) }}" method="post">
                    <div class="btn-group btn-group-justified">
                        <div class="btn-group">
                            <a href="{{ URL::route('public.campaigns.edit', [ 'id' => $campaign->id ]) }}" class="btn btn-primary"><i class="glyphicon glyphicon-edit"></i> @lang('campaigns.buttons.edit')</a>
                        </div>
                        <div class="btn-group">
