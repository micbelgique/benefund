    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group {{ $errors->has('date_start') ? 'has-error has-feedback' : '' }}">
                ...
                <input type="date" class="form-control" name="date_start" id="date_start" value="{{ date('Y-m-d', max(strtotime(Input::old('date_start')), 0)) }}" placeholder="@lang('campaigns.form.placeholders.date_start')">
        ...
        <div class="col-md-6">
            <div class="form-group {{ $errors->has('date_end') ? 'has-error has-feedback' : '' }}">
                ...
                <input type="date" class="form-control" name="date_end" id="date_end" value="{{ date('Y-m-d', max(strtotime(Input::old('date_end')), 0)) }}" placeholder="@lang('campaigns.form.placeholders.date_end')">
        ...
        <div class="col-md-6">
            <div class="form-group {{ $errors->has('item_title') ? 'has-error has-feedback' : '' }}">
                ...
                <input type="text" class="form-control" name="item_title" id="item_title" value="{{ Input::old('item_title', $campaign->item_title) }}" placeholder="@lang('campaigns.form.placeholders.item_title')">
        ...
        <div class="col-md-6">
            <div class="form-group {{ $errors->has('item_item_description') ? 'has-error has-feedback' : '' }}">
                <label for="name">@lang('campaigns.form.labels.item_description')</label>
        ...
        <div class="col-md-6">
            <div class="form-group {{ $errors->has('item_price') ? 'has-error has-feedback' : '' }}">
                ...
                <input type="text" class="form-control" name="item_price" id="item_price" value="{{ Input::old('item_price', round($campaign->item_price / 100, 2)) }}" placeholder="@lang('campaigns.form.placeholders.item_price')">
