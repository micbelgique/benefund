<h2 class="page-header">@lang('campaigns.edit.title')</h2>
...
<form action="{{ URL::route('public.campaigns.update', [ 'id' => $campaign->id ]) }}" method="post">
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group {{ $errors->has('date_start') ? 'has-error has-feedback' : '' }}">
                ...
                <input type="date" class="form-control" name="date_start" id="date_start" value="{{ Input::old('date_start', $campaign->date_start) }}" placeholder="@lang('campaigns.form.placeholders.date_start')">
        ...
        <div class="col-md-6">
            <div class="form-group {{ $errors->has('date_end') ? 'has-error has-feedback' : '' }}">
                ...
                <input type="date" class="form-control" name="date_end" id="date_end" value="{{ Input::old('date_end', $campaign->date_end) }}" placeholder="@lang('campaigns.form.placeholders.date_end')">
        ...
        <div class="col-md-6">
            <div class="form-group {{ $errors->has('item_title') ? 'has-error has-feedback' : '' }}">
                <label for="name">@lang('campaigns.form.labels.item_title')</label>
        ...
        <div class="col-md-6">
            <div class="form-group {{ $errors->has('item_price') ? 'has-error has-feedback' : '' }}">
                ...
                <input type="text" class="form-control" name="item_price" id="item_price" value="{{ Input::old('item_price', round($campaign->item_price / 100, 2)) }}" placeholder="@lang('campaign.form.placeholders.item_price')">
    ...
    {{ Form::token() }}
    <button class="btn btn-primary"><i class="glyphicon glyphicon-ok"></i> @lang('campaigns.form.edit.submit')</button>
</form>